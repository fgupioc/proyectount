 ...
 * @author Franz
 */
public class FormConsultaPortafolioPersonal extends javax.swing.JInternalFrame {

    /**
     * Creates new form FormGestionarUnidad
     */ 
    Area area;
    private GestionarPersonalServicio gper;
    private List<Area> areas;

    public FormConsultaPortafolioPersonal(java.awt.Frame parent, boolean modal) { 
        initComponents(); 
        mostrar();
        botones(false); 
    ...
    private void mostrar() {
       try {
            gper = new GestionarPersonalServicio();
            List<Personal>personales = new ArrayList();
            personales = gper.listarPersonal();
            gper.llenarLista(listado, personales);
            ocultar();
 ...
 public void ocultar() {
    ...
    private void btnConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConsultarActionPerformed
       ...
       if(!lblCodigo.getText().equals("codigo")){
        try {
            gm.reportePortafolio(lblCodigo.getText());
        } catch (Exception ex) {
            Logger.getLogger(FormConsultaPortafolioPersonal.class.getName()).log(Level.SEVERE, null, ex);
        }
       }
